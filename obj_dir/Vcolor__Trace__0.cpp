...
void Vcolor___024root__trace_chg_sub_0(Vcolor___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgSData(oldp+0,(vlSelf->color__DOT__address),11);
        bufp->chgCData(oldp+1,((0x3fU & VL_MODDIV_III(11, (IData)(vlSelf->color__DOT__address), (IData)(0x28U)))),6);
        bufp->chgCData(oldp+2,((0x1fU & VL_DIV_III(11, (IData)(vlSelf->color__DOT__address), (IData)(0x28U)))),5);
        ...
        bufp->chgIData(oldp+15,(vlSelf->color__DOT__pixel_out),32);
        bufp->chgCData(oldp+16,(vlSelf->color__DOT__filter3x3__DOT__pixels
                                [0U][0U]),8);
        bufp->chgCData(oldp+17,(vlSelf->color__DOT__filter3x3__DOT__pixels
                                [0U][1U]),8);
        ...
        bufp->chgCData(oldp+24,(vlSelf->color__DOT__filter3x3__DOT__pixels
                                [2U][2U]),8);
        bufp->chgCData(oldp+25,(vlSelf->color__DOT__filter3x3__DOT__edge_handler__DOT__horizontally_extended
                                [0U][0U]),8);
        bufp->chgCData(oldp+26,(vlSelf->color__DOT__filter3x3__DOT__edge_handler__DOT__horizontally_extended
                                [0U][1U]),8);
